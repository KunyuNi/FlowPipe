...
# test传入 flowpipe/exp/flowpipe-3linear/
class Info:
    def __init__(
        self,
        ...
        llm_embedding_prefix="LLM/llm_embedding"
    ) -> None:
        self.aipipe_core_prefix = aipipe_core_prefix  # data/meta
        self.result_prefix = result_prefix   # data/train_result
        self.dataset_prefix = dataset_prefix  # data/dataset
        self.llm_embedding_prefix = llm_embedding_prefix
        self._makedirs()
